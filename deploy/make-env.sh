...
INTERNAL_API_KEY="aijd_internal_$(gen 48 48)"
...
# worker → api /internal/* 호출 인증 키 (봇 자동 운영·커리큘럼 예약 게시)
...
KAKAO_ENABLED=true
# 카카오톡 공유 버튼용 JS 키 (빌드 타임 인라인 — compose build.args 로 전달됨)
NEXT_PUBLIC_KAKAO_JS_KEY=$(val NEXT_PUBLIC_KAKAO_JS_KEY)
