...
/** 자료 유형 — Rules·설정 하위 게시판은 Rules / 설정 파일 두 유형을 받는다. */
const resourceTypes = [
  { value: "rule", label: "Rules", icon: "git-repository-line", hint: "md·mdc 권장 · Cursor/Claude rules" },
  { value: "config", label: "설정 파일", icon: "settings-3-line", hint: "zip·json 권장 · 설정 파일 묶음" },
] as const;
...
const SUGGESTED_TAGS = [
  "Cursor", "Rules", "설정", "Next.js", "TypeScript",
  "Python", "ESLint", "Prettier", "ClaudeCode", "규칙",
];
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      <header className={styles.formHeader}>
        ...
        <h1 className={styles.formTitle}>Rules·설정 자료 등록</h1>
        <p className={styles.formDesc}>
          Cursor·Claude의 rules나 설정 파일을 올리고 설명을 적으면 다른 사람이 받아서 바로 적용할 수 있습니다.
          실제 내용은 첨부 파일 안에 포함해 주세요.
        </p>
      </header>
      ...
      <div className={styles.field}>
        ...
        <input
          ...
          type="text"
          placeholder="자료 이름을 입력하세요 (예: Next.js Cursor Rules 모음)"
          value={title}
          maxLength={80}
      ...
      <div className={styles.field}>
        ...
        <div className={styles.textareaBox}>
          <textarea
            ...
            placeholder="어떤 규칙·설정인지, 어디에 넣고 어떻게 적용하는지 설명해 주세요."
            value={desc}
            maxLength={MAX_DESC}
        ...
        <div className={styles.tagBox}>
          ...
          {tags.length < MAX_TAGS && (
            <input
              ...
              type="text"
              placeholder={tags.length === 0 ? "태그를 입력하고 Enter (예: Cursor)" : ""}
              value={tagInput}
      ...
      <div className={styles.formActions}>
        <Link href="/resources/rules" className={styles.cancelBtn}>
          취소
        </Link>
