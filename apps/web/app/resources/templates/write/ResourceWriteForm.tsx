...
/** 자료 유형 — 템플릿·체크리스트 하위 게시판은 문서 템플릿 / 체크리스트 두 유형을 받는다. */
const resourceTypes = [
  { value: "template", label: "문서 템플릿", icon: "file-list-3-line", hint: "docx·md 권장 · 빈칸 채우는 문서" },
  { value: "checklist", label: "체크리스트", icon: "checkbox-multiple-line", hint: "md 권장 · 점검 항목 목록" },
] as const;
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      <header className={styles.formHeader}>
        ...
        <h1 className={styles.formTitle}>템플릿·체크리스트 자료 등록</h1>
        <p className={styles.formDesc}>
          바로 채워 쓸 수 있는 문서 템플릿이나 체크리스트를 올리고 설명을 적으면 다른 사람이 받아서 바로 적용할 수 있습니다.
      ...
      <div className={styles.field}>
        ...
        <input
          ...
          type="text"
          placeholder="자료 이름을 입력하세요 (예: PRD 문서 템플릿)"
          value={title}
          maxLength={80}
      ...
      <div className={styles.field}>
        ...
        <div className={styles.textareaBox}>
          <textarea
            ...
            placeholder="어떤 문서·체크리스트인지, 언제 어떻게 쓰는지 설명해 주세요."
            value={desc}
            maxLength={MAX_DESC}
        ...
        <div className={styles.tagBox}>
          ...
          {tags.length < MAX_TAGS && (
            <input
              ...
              type="text"
              placeholder={tags.length === 0 ? "태그를 입력하고 Enter (예: 템플릿)" : ""}
              value={tagInput}
      ...
      <div className={styles.formActions}>
        <Link href="/resources/templates" className={styles.cancelBtn}>
          취소
        </Link>
