CREATE TYPE "public"."sanction_type" AS ENUM('warning', 'suspend', 'permaban');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"banner_url" text,
	"links" jsonb,
	"default_avatar_index" integer DEFAULT 0 NOT NULL,
...
CREATE INDEX "user_sanctions_user_id_idx" ON "user_sanctions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "user_sanctions_type_idx" ON "user_sanctions" USING btree ("type");--> statement-breakpoint
